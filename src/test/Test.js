...
//     let allOrders = {};
//     const [ord, setOrd] = useState(allOrders["200608BAD4C443GA"]);

//     setTimeout(() => {
//         setOrd(allOrders["200608BAD4C443GA"]);
//     }, 2000);
...
//     console.log(
//         Object.values(allOrders).filter((i) => {
//             return i.customer.address.includes("934");
//         })
//     );
